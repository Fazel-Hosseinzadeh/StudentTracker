...
STATIC_URL = '/static/'
STATISTICFILES_STORAGE = 'cloudinary_storage.storage.StatisticHashedCloudinaryStorage'
STATISTICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]
STATISTICFILES_ROOT = os.path.join(BASE_DIR, 'staticfiles')
MEDIA_URL = '/media/'
